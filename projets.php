...
<link rel="stylesheet" media="screen and (min-width:240px) and (max-width:600px)" href="css/smallscreen.css" type="text/css" />
	...
	<title>Jophas Work, decouvret mes projets web.</title>
	<script>
...
<div class="main-header">
    <nav class="main-nav">
        <ul>
            <li class="folio bord redbord"><a href="http://jophasworks.com/projets.php">Projets web</a></li>
	...
	<div class="categorie"><p>Mes projets de developpement web</p></div>
