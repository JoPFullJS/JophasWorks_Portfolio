...
<div class="main-header">
    <nav class="main-nav">
        <ul>
            <li class="folio bord"><a href="http://jophasworks.com/projets.php">Projets web</a></li>
              <li class="creation bord redbord"><a href="http://jophasworks.com/creations.php">Creations</a></li>
	...
	<div class="categorie"><p>Mes Cr&eacute;ations graphiques</p></div>
	...
	<div class="content_list" id="main" >
			...
			<div class="projet_list crea_list">
			  ...
			  <div class="photo_list"><article class="img_box"><img class="imaged" src="<?php echo $verif_select['lk_list']; ?>" /><a class="fonction" href="<?php echo $verif_select['lk_fichier']; ?>">
				  <div class="link"><img src="img/link_icon.png" height="150"/><p class="link_txt"><?php echo $verif_select['fonction']; ?></p></div>
			  </a></article></div>
			  <div class="rating">
				<div class="vue_box"><p><?php echo $verif_select['nb_vue']; ?>&nbsp;Vues</p></div>
				<div class="com_box"><p><?php echo $verif_select['nb_com']; ?>&nbsp;Commentaires</p></div>
			  </div>
			</div>
		<?php } ?>
