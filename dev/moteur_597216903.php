<?php
   ...
   $video_select = "SELECT a.ID_element,a.ID,a.ID_categorie,a.titre,a.description,a.date,a.icon,b.ID_lien,b.lk_image,b.lk_code,b.lk_demo,c.id_stat,c.nb_vue,d.ID_compteur,d.vt_pos,d.vt_neg,e.ID_societe,e.lk_societe,e.societe,e.lk_logo FROM descriptions AS a,lien AS b,statistiques AS c,compteur AS d,societe AS e WHERE a.ID_element=b.ID_lien AND a.ID_element=c.id_stat AND a.ID_element=d.ID_compteur AND a.ID_element=e.ID_societe AND ID_element IN ('".$id."')";
...
<head>
	...
	<link href='http://fonts.googleapis.com/css?family=Dancing+Script:400,700' rel='stylesheet' type='text/css'><link href="../css/principale.css" rel="stylesheet">
		...
		<div class="content_topic">
			...
			<div class="content_image">
				<div class="image_margin">
					...
					<div class="image_link"><p class="link_align"><a href="<?php echo $verif_video['lk_demo']; ?>">Code source sur <strong>GITHUB</strong> !</a><p></div>

						<div class="info_type">
							<div class="grafik_type"><p>Technologies utilis&eacute;es</p></div>
							<div class="logiciels">
								<ul>
								<?php
								...
								{
									echo '<li class="arg"><img src="../img/filter/'.$icon[$i].'.png" title="'.$icon[$i].'" alt="'.$icon[$i].'" width="50" /></li>';
								}
								?>
								</ul>
							</div>
					...
					<div class="code">
						<div class="titre_code">
							<p>Diagramme descriptif</p>
						</div>
						<div class="list_code">
							<div id="tabs" class="code_margin">
								<?php echo $verif_video['lk_code']; ?>
